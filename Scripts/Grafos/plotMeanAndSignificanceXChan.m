function plotMeanAndSignificanceXChan(mat1,mat2,statmethod,p_value,color1,color2,colorPvalue,conditionName1,conditionName2,labels,titleName,root)

%meanMat1 = mean(mat1,1);
%meanMat2 = mean(mat2,1);
