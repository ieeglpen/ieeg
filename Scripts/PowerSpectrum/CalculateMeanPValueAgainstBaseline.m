function [t,pvals,meanbaselineValue,meantimeWindowValue] = CalculateMeanPValueAgainstBaseline(erps,frequencyIndex,baselineIndex,timeWindowIndex)
%INPUTS
