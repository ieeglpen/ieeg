function PlotERPSForDiffConditions(erpsByROIsCond1,erpsByROIsCond2,file2SaveName,path2save,g,Pboot,ERP,mbase,freqs,timesout,roiStruct)    
...
maskerspDIFF = [];
titleName = [path2save file2SaveName];
...
for k = 1 : size(roiStruct,2)
    ...
    myplottimef(plotTitleName,erpsDiff, R, Pboot, Rboot, ERP, freqs, timesout, mbase, maskersp, maskitc, g);
