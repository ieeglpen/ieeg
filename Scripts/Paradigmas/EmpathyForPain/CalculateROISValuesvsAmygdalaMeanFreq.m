function [labels,trialsResults] = CalculateROISValuesvsAmygdalaMeanFreq(EmpathyForPainStruct,ROIINT,ROIACC,AmygdalaDiff,timeWindow,frequencyIndex,baseTimeWindow,pvalue)
