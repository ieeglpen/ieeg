function MergeAndPreprocessInteroData(filename1,filename2,mergedFileName,filepath,notchHz,notchWidth,bandpassRange,channels2Delete,labelFileName,filteredFileName,referencedFileName,preprocessedLabelFileName,channelLocationFileName,event2Epoch,epochWindow,doRebase,rebaseWindow)
...
%PREPROCESS!!!!
%Preprocess(fileName,filePath,labelFileName,channels2Delete,notchHz,notchWidth,bandpassRange,filteredFileName,referencedFileName)
...
%preprocessedLabelFileName = strcat('Peirone_Block',num2str(i),'_Preprocessed');
EEG = newEEG;

if ~strcmp('',channelLocationFileName)
    PreprocessChannelLocation(channelLocationFileName,channels2Delete,preprocessedLabelFileName);
end
